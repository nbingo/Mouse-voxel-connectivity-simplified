...
pp = ProjPredictor(image_file='dentate_signal_aligned_100um_binarized.tif', source_area='Dentate', verbose=True)
...
pp.set_image_from_file('interposed_signal_aligned_100um_binarized.tif', source_area='Interposed')
pp.filter_by_name('Thalamus')
pp.vol_to_probs()
# pp.view_proj()
